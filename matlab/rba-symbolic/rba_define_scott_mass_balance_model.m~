...
rba_model_components.elements.localized_protein.IDsymbol            = numbered_names('prt',2,0);
...
rba_model_components.connections.L_target_metabolite                 = 0;
rba_model_components.connections.L_target_reaction_flux              = 1;
rba_model_components.connections.L_target_process_flux               = 0;
rba_model_components.connections.L_target_protein                    = [0 0];
rba_model_components.connections.L_target_machine                    = 0;
